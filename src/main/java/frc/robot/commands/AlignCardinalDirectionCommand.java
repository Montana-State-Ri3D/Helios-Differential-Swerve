...
public class AlignCardinalDirectionCommand extends CommandBase {
  ...
  private PIDController pid = new PIDController(7.0, 0.0, 0.0);
  ...
  public void execute() {
    ...
    drivetrain.setTargetChassisVelocity(ChassisSpeeds.fromFieldRelativeSpeeds(0, 0, rotationSpeed, currentRotation));
  }

  @Override
  public void end(boolean interrupted) {
    drivetrain.setTargetChassisVelocity(new ChassisSpeeds(0, 0, 0));
  }
